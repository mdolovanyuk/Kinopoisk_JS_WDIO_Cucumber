class TodayInCinemaPage {
    ...
    get genresAndYears() {return $$('.today-in-cinema__carousel .film-poster-snippet__caption_theme_default')}; //touch
    get ratings() {return $$('.today-in-cinema__carousel .film-rating-bar_scaled')}; // touch
    ...
    get sectionTitle() { return $('//h3[text() = "Смотрите в кино"]')}; // touch
}
